...
namespace Compression
{
    ...
    public class AdaptiveHuffmanStream : Stream, IDisposable
    {
        ...
        public AdaptiveHuffmanStream(Stream baseStream, StreamDirection direction)
        {
            ...
            {
                throw new ArgumentException(EWBSCoreWarnings.ComCantReadUnderlyingStream);
            }
            else if (direction == StreamDirection.Write && !baseStream.CanWrite)
            {
                throw new ArgumentException(EWBSCoreWarnings.ComCantWriteUnderlyingStream);
            }
        ...
        {
            get { return _open && _direction == StreamDirection.Read; }
        }
        ...
        {
            get { return _open && _direction == StreamDirection.Write; }
        }
        ...
        public override long Position
        {
            ...
            set { throw new NotSupportedException(EWBSCoreWarnings.ComCantSeekCompressionStream); }
        }
        ...
        public override int ReadByte()
        {
            ...
            if (node == null) throw new ApplicationException(EWBSCoreWarnings.ComTreeCantBeEmpty);
            ...
            while (node.LeftChild != null)
            {
                ...
                else throw new ApplicationException(EWBSCoreWarnings.ComInvalidBitInStream);
            }
        ...
        public override void Close()
        {
            ...
            if (_open)
            {
                ...
                _bitStream.Close();
                _bitStream.Dispose(); //#BR17164 THOMAS標記由GC釋放
                _bitStream = null;
                _open = false;
                _eos = true;
                System.GC.Collect(); //#BR17164 THOMAS GC強制回收
        ...
        {
            get { throw new NotSupportedException(EWBSCoreWarnings.ComCantSeekCompressionStream); }
        }

        /// <summary>Not Supported.</summary>
        public override void SetLength(long value)
        {
            throw new NotSupportedException(EWBSCoreWarnings.ComCantSetLengthCompressionStream);
        }

        /// <summary>Not Supported.</summary>
        public override long Seek(long offset, SeekOrigin origin)
        {
            throw new NotSupportedException(EWBSCoreWarnings.ComCantSeekCompressionStream);
        }

        /// <summary>Not Supported.</summary>
        public override void EndWrite(IAsyncResult asyncResult)
        {
            throw new NotSupportedException(EWBSCoreWarnings.ComCantAsyncAccessCompressionStream);
        }
    ...
    internal class AdaptiveHuffmanTree
    {
        ...
        private void SwapNodes(AdaptiveHuffmanTreeNode node1, AdaptiveHuffmanTreeNode node2)
        {
            ...
            if (node1.Parent == null || node2.Parent == null) throw new ApplicationException(EWBSCoreWarnings.ComCantSwapRootNodes);
    ...
    internal class AdaptiveHuffmanTreeNode
    {
        ...
        public AdaptiveHuffmanTreeNode LeftChild
        {
        ...
        public AdaptiveHuffmanTreeNode RightChild
        {
        ...
        public AdaptiveHuffmanTreeNode Parent
        {
            get { return _parent; }
            set { _parent = value; }
        }
