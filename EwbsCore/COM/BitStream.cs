...
namespace Compress.IO
{
    ...
    public class BitStream : Stream, IDisposable
    {
        ...
        {
            get { throw new NotSupportedException(EWBSCoreWarnings.ComCantSeekBitStream); }
        }
        ...
        public override long Position
        {
            ...
            set { throw new NotSupportedException(EWBSCoreWarnings.ComCantSeekBitStream); }
        }
        ...
        {
            get { return _closeBaseStream; }
            set { _closeBaseStream = value; }
        }
        ...
        public void WriteBit(int bit)
        {
            ...
            if (!CanWrite) throw new NotSupportedException(EWBSCoreWarnings.ComCantWriteThisStream);
            if (bit != 0 && bit != 1) throw new ArgumentException(EWBSCoreWarnings.ComBitMustBe01, "bit");
        ...
        public int ReadBit()
        {
            ...
            if (!CanRead) throw new NotSupportedException(EWBSCoreWarnings.ComCantReadThisStream);
        ...
        public override void Close()
        {
            ...
            if (_open)
            {
                ...
                _baseStream.Dispose(); //#BR17164 THOMAS標記由GC釋放
                _baseStream = null;
                _bitBuffer = 0;
                _curPos = 0;
        ...
        {
            throw new NotSupportedException(EWBSCoreWarnings.ComCantSetLengthBitStream);
        }

        /// <summary>Not Supported.</summary>
        public override long Seek(long offset, SeekOrigin origin)
        {
            throw new NotSupportedException(EWBSCoreWarnings.ComCantSeekBitStream);
        }

        /// <summary>Not Supported.</summary>
        public override void EndWrite(IAsyncResult asyncResult)
        {
            throw new NotSupportedException(EWBSCoreWarnings.ComCantAsyncAccessBitStream);
        }
